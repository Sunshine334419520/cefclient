...
#include "tests/cefsimple/browser/handler.h"
#include "tests/cefsimple/browser/simple_browser_app.h"
//#include "tests/cefsimple/simple_render_app.h"
//#include "tests/cefsimple/simple_other_app.h"
...
- (void)tryToTerminateApplication:(NSApplication*)app {
  simple::SimpleHandler* handler = simple::SimpleHandler::GetInstance();
...
int main(int argc, char* argv[]) {
  ...
  if (process_type == SimpleApp::BrowserProcess)
    app = new SimpleBrowserApp();
  /*
  else if (process_type == SimpleApp::RenderProcess)
